...
2.  Use
    [`suggest_relationships()`](https://gbasulto.github.io/ERDbuilder/reference/suggest_relationships.md)
    to identify likely relationships.
3.  Review and, when necessary, edit the suggested relationships.
4.  Create an ERD object with
    [`create_erd()`](https://gbasulto.github.io/ERDbuilder/reference/create_erd.md).
5.  Check the ERD with
    [`validate_erd()`](https://gbasulto.github.io/ERDbuilder/reference/validate_erd.md).
...
| Function | Purpose |
|:---|:---|
| [`suggest_relationships()`](https://gbasulto.github.io/ERDbuilder/reference/suggest_relationships.md) | Suggest relationships between data frames |
| [`format_relationships()`](https://gbasulto.github.io/ERDbuilder/reference/format_relationships.md) | Convert a relationship specification into paste-ready R code |
| [`create_erd()`](https://gbasulto.github.io/ERDbuilder/reference/create_erd.md) | Create an ERD object |
| [`validate_erd()`](https://gbasulto.github.io/ERDbuilder/reference/validate_erd.md) | Validate the ERD structure and optionally inspect observed cardinalities |
| [`is_valid_erd()`](https://gbasulto.github.io/ERDbuilder/reference/is_valid_erd.md) | Return whether an ERD passes validation |
| [`render_erd()`](https://gbasulto.github.io/ERDbuilder/reference/render_erd.md) | Render an ERD |
| [`perform_join()`](https://gbasulto.github.io/ERDbuilder/reference/perform_join.md) | Join tables using relationships stored in an ERD |

## Suggesting relationships

[`suggest_relationships()`](https://gbasulto.github.io/ERDbuilder/reference/suggest_relationships.md)
examines pairs of data frames and evaluates possible join columns using
information such as:
...
Use
[`format_relationships()`](https://gbasulto.github.io/ERDbuilder/reference/format_relationships.md)
to convert the suggested object into R code:
...
By default,
[`validate_erd()`](https://gbasulto.github.io/ERDbuilder/reference/validate_erd.md)
distinguishes between structural errors and warnings based on the
observed data.
